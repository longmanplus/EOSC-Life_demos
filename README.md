...
A [taverna](http://www.taverna.org.uk/download/workbench/) workflow to demonstrate the FAIRness (automatically found and reused by machines) of mappings (as data) between the terms of two standard medical ontologies through [FAIR Data Points](https://github.com/FAIRDataTeam/FAIRDataPoint-Spec). 
