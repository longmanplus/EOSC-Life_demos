...
A taverna workflow was developed to demonstrate the FAIRness (automatically found and reused by machines) of mappings between the terms of two medical ontologies through [FAIR Data Points](https://github.com/FAIRDataTeam/FAIRDataPoint-Spec). 
